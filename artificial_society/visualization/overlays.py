...
from artificial_society.systems.remedy import REMEDY_REGISTRY, DISEASE_COLORS  # type: ignore

# Try importing DISEASE_COLORS; graceful fallback
try:
    from artificial_society.renderer import DISEASE_COLORS
except Exception:
    DISEASE_COLORS = {}
...
def _color_for_value(value, low=0.0, high=100.0, invert=False):
    """Green → Yellow → Red gradient for stat bars."""
