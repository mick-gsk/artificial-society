...
def _stat_row(screen, small, label, value_str, bar_val, lo, hi, x, y, w, invert=False, color=None):
...
def draw_dashboard(screen, x, y, w, h, stats, tribes, technology, font, font_bold, small, tick=0):
    ...
    if seg_c > 0:
        pygame.draw.rect(screen, (200, 230, 255), (bar_x, bar_y, seg_c, bar_h2), border_radius=2)
    if seg_a > 0:
        pygame.draw.rect(screen, (90, 200, 110), (bar_x + seg_c, bar_y, seg_a, bar_h2))
    if seg_e > 0:
        pygame.draw.rect(
            screen, (200, 170, 90), (bar_x + seg_c + seg_a, bar_y, seg_e, bar_h2), border_radius=2
        )
    yy += 28
    for col, lbl, cnt in [
        ((200, 230, 255), "Child", n_c),
        ((90, 200, 110), "Adult", n_a),
        ((200, 170, 90), "Elder", n_e),
    ]:
