...
TRAIT_RANGES = {
    ...
    "efficiency": (0.4, 1.5),
    "replication_rate": (0.5, 1.5),
    "spawn_delay_efficiency": (0.5, 1.5),
    "plasticity": (0.3, 1.8),
...
def random_traits():
    return {
        ...
        "replication_rate": random.uniform(*TRAIT_RANGES["replication_rate"]),
        "spawn_delay_efficiency": random.uniform(*TRAIT_RANGES["spawn_delay_efficiency"]),
