...
MATERIALS: dict[str, np.ndarray] = {
    ...
    'seed_grain':    _v(flammable=0.1,  hardness=0.3,  edibility=0.5,  mass=0.05,
                        dryness=0.7,  solubility=0.15),
    'leaf':          _v(flammable=0.4,  hardness=0.05, edibility=0.15, mass=0.03,
                        dryness=0.4,  solubility=0.3,  scent=0.2),
    'soil':          _v(flammable=0.0,  hardness=0.2,  edibility=0.0,  mass=0.8,
                        dryness=0.3,  solubility=0.5,  conductivity=0.2),
    'water_drop':    _v(flammable=0.0,  hardness=0.0,  edibility=0.3,  mass=0.1,
                        dryness=0.0,  solubility=1.0),
}
