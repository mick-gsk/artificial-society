...
Phases (0..1 = fraction of day):
  ...
  0.58-1.00  night    -- darkness, high attacker danger, sleep pressure

Light is a float 0..1 that drives:
  - Gathering efficiency (agent.py)
  - Attacker danger bonus on cells (world)
...
def day_phase(tick: int) -> dict:
    ...
    Returns a state dict for the current tick:
      ...
      light   : float 0..1
      danger_mult : float -- night attackers
