...
class World:
    ...
    def update_events(self, tick, season_state, weather_state):
        # Physics-driven genesis + lifecycle live in environment/events.py
        # (storms follow storm_risk and wind, droughts form over the driest
        # warm region, fires need ignition+fuel+dryness, blight needs moist
        # dense vegetation). The application path below (event_field /
        # event_fields_grid -> regrow_grid) is unchanged.
